...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <header class="foi-header-cnt  landing-header-malta"
                ...
                <div class="header-content-cnt" style="margin-top:150px">
                    <div class="row">
                        <div class="col-md-7 order-2 order-sm-1" data-aos="fade-right" data-aos-duration="1000">
                            <h1 style="color:#574240; line-height:4rem;">Your Dream Country is Malta?</h1>
                            <h3 style="color:#141313; line-height:4rem;">Get support for your education in Malta by
        ...
        <div class="container " style=" margin-top:90px;box-shadow: 1px 1px 9px 3px rgba(0,0,0,0.08);">
            <div class="row ">
                ...
                <div class="col-8 offset-2">
                    <h3 class="text-center mt-5 mb-5">Everything you need for your Malta dream</h3>
                </div>
            </div>
            <div class="container">
                <div class="row">
                ...
                <div class="col-12  mt-5">
                    <div class="px-sm-5 text-sm-center" style="color: #242020; align-items: center;">
                        ...
                        <button type="button" class="btn get_started" id="requestbtn"
                            style="color: white; border-radius:24px;" data-bs-toggle="modal"
        ...
        <div class="container" style="overflow: hidden;">
            ...
            <section class="foi-page-section pt-0">
                <div class="row">
                        ...
                        <div class="container-fluid">
                            <div class="container cnt-reason-aus">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-7">
                                        <p class="" style="display: inline;"><b>Exciting job opportunities</b></p>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-1 offset-2">
                                    ...
                                    <div class="col-7">
                                        <p class="" style="display: inline;"><b>Support for Startups</b></p>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-1 offset-2">
                                    ...
                                    <div class="col-7">
                                        <p class="" style="display: inline;"><b>A great place to improve your English</b></p>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-1 offset-2">
                    ...
                    <div class="col-md-6 pl-lg-0 d-flex align-items-lg-top align-items-lg-end order-1 order-md-2 sm-cnt-aus"
                        data-aos="fade-left" data-aos>
                        <img src="assets/images/malta.png" alt="about" class="img-fluid" width="80%"
            ...
            <section class="foi-page-section mt-0 pt-0">
                <div class="row">
                        ...
                        <div class="container-fluid">
                            <div class="container cnt-reason-aus">
                                <div class="col-md-12 opacity-animation-cnt1">
                                    <h4 class="offset-1">Application checklist for admission:
                                    </h4>
                                    <div class="about-section-two-content">
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-7">
                                                <p class="" style="display: inline;">Application fees</p>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-1 offset-1">
                                            ...
                                            <div class="col-7">
                                                <p class="" style="display: inline;">High School</p>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-1 offset-1">
                                            ...
                                            <div class="col-7">
                                                <p class="" style="display: inline;">Intermediate</p>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-1 offset-1">
                                            ...
                                            <div class="col-7">
                                                <p class="" style="display: inline;">Bachelor’s memorandum of marks</p>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-1 offset-1">
                                            ...
                                            <div class="col-7">
                                                <p class="" style="display: inline;">Degree award</p>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-1 offset-1">
                                            ...
                                            <div class="col-7">
                                                <p class="" style="display: inline;">Master memorandum of marks
                                                </p>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-7">
                                                <p class="" style="display: inline;">Degree award
                                                </p>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-7">
                                                <p class="" style="display: inline;">2 Reference letters</p>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-1 offset-1">
                                            ...
                                            <div class="col-7">
                                                <p class="" style="display: inline;">Passport 1st and last page</p>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-1 offset-1">
                                            ...
                                            <div class="col-7">
                                                <p class="" style="display: inline;">IELTS (Can be exempted if the student clears his Skype interview)
                                                </p>
                                            </div>
                                        </div>
