    ...
    if ($no_of_row>0){
        ...
        if ($result) {
            ...
            if ($result) {
                ...
                $emailto=$_SESSION["agent_email"];
                $name=$_POST["agent_name"];
                $mail_subject="New Invitation";
                $mail_message="Congratulations!!! Your application for agent at gleam education is accepted. 
                <br>
                Please use following credentials for login into gleam agent portal: <br>
                ...
                window.location.href="../../frontend/aadmin/new_agent.php"
                <script>';
            }
