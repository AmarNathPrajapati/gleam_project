...
<div id="loader" class="center"></div>
                    ...
                    <div class="card shadow border-0 mb-7">
                        <div class="card-header">
                            <div class="container-fluid p-sm-5 my-5" style="font-size: 22px;">
                                <form id="update_form" action="../../backend/gleam_admin/gleam_admin_application_update.php" onsubmit="return submitform()" method="post"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <br>
                                        <div class="col-12">
                                            <input type="text" class="form-control" readonly required name="name" value=" <?php echo $row["name"];?>">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <br>
                                        <div class="col-12">
                                            <input type="text" class="form-control" readonly required name="email" value=" <?php echo $row["email"];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <br>
                                        <div class="col-12">
                                            <input type="text" class="form-control" readonly required name="phone" value=" <?php echo $row["phone"];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <br>
                                        <div class="col-12">
                                            <input type="text" class="form-control" id="showcountry" name="showcountry" readonly
                                            ...
                                            <select name="country" id="country" hidden>
                                                <?php
                                                  if ($data->num_rows>0) {
                                                   ...
                                                   ?>
                                                    <option <?php echo $row["country_id"]==$country_row['id']?"selected":"";?>
                                                        value="<?php echo $country_row['id']; ?>">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <br>
                                        <div class="col-12">
                                            <input type="text" class="form-control" readonly required name="university_name"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-12" id="moredocument">
                                         ...
                                         if ($result) {
                                            ...
                                            $data= mysqli_stmt_get_result($sql);
                                            if ($data->num_rows>0) {
                                                while($row56=mysqli_fetch_array($data)){
                                                    ?>

                                            <div id="<?php echo $row56['id']; ?>">
                                                <input type="number" hidden name="doc_id[]" readonly
                                                    value="<?php echo $row56['id']; ?>">
                                                 <input type="text" name="document_location[]" hidden value="<?php echo $row56['document_location'];?>">
                                                <input type="text" class="form-control mb-3"
                                                    oninput="update(<?php echo $row56['id']; ?>)" required
                                                    name="doc_name[]" readonly
                                                    value="<?php echo $row56['document_name']; ?>">
                                                <a class="btn btn-neutral mb-3 text-primary" name="doc_download[]"
                                                    href="<?php echo '../../documents/agent/'.$row56['document_location'];?>">
                                                     Download <i class="bi bi-download"></i></a>

                                                <input type="file" oninput="update(<?php echo $row56['id']; ?>)"
                                                    accept=".pdf,.png,.docs,.docx,.jpeg,.jpg" class="form-control mb-3"
                                                    name="document[]" hidden>

                                                <button type="button" class="btn btn-neutral text-danger p-2 mb-3" name="deletebtn[]" hidden
                                                    onclick="delete_div(<?php echo $row56['id']; ?>)"><i class="bi bi-trash-fill"></i> Remove</button>
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        <!-- <button class="btn btn-neutral col-auto text-danger" onclick="make_editable()" type="button"
                                            id="editbtn">Edit Details</button> -->
                                        <!-- <button class="btn btn-neutral col-auto text-success" type="submit" id="updatebtn"
                                            style="margin-right: 10px;" hidden>Update</button>
                                        <button class="btn btn-neutral col-auto text-warning" onclick="make_uneditable()"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-12">
                                            <input type="number" hidden id="old_status" name="old_status" readonly
                                                ...
                                                <input type="number" hidden id="application_id" name="application_id" readonly
                                            ...
                                            <div class="row my-3">
                                                <button class="btn btn-neutral col-auto text-danger" onclick="make_editable2()" type="button"
                                                    id="editbtn">Edit Status</button>
                                                <button class="btn btn-neutral col-auto text-success" type="submit" id="updatebtn"
                                                    style="margin-right: 10px;" hidden>Update Status</button>
                                                <button class="btn btn-neutral col-auto text-warning" onclick="make_uneditable2()"
                                                    type="button" id="cancelbtn" hidden>Cancel</button>
                                            </div>
                                        </div>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="view_box border-1 mb-3" >
                                    ...
                                    <?php 
                                        ...
                                        $stmt="SELECT users.name,chat_table.* FROM chat_table INNER JOIN users ON users.id=chat_table.from_user
                                        ...
                                        if($data->num_rows==0){
                                            ...
                                            while($row=mysqli_fetch_array($data)){
                                                ?>
                                                <div name="<?php echo $row['from_user']==$_SESSION['gleam_admin_id']?'rightMessage':'leftMessage'?>" 
                                                    class="<?php echo $row['from_user']==$_SESSION['gleam_admin_id']?'rightMessage':'leftMessage'?>">
                                                    <h6  class="<?php echo $row['from_user']==$_SESSION['gleam_admin_id']?'textWhite':'textDark'?> sender_name"><?php  
                                                        if($row['from_user']!=$_SESSION['gleam_admin_id']){
                                                            echo "By ".$row['name'];
                                                        }
                                                        // else{
                                                        //     echo 'By You';
                                ...
                                <div class="send_box">
                                    <form action="#">
                                        ...
                                        <input type="number" hidden name="agent_id123" value="<?php echo $agent_id123; ?>">
                                        <input type="number" hidden name="admin_id123" value="<?php echo $_SESSION['gleam_admin_id']; ?>">
    ...
    <script>
        ...
        function make_editable() {
            ...
            document.getElementById('showstatus').setAttribute('hidden', 'hidden');
    ...
    <script>
        function sendMessage(){
            ...
            var to_user=document.getElementsByName('agent_id123')[0].value;
            var from_user=document.getElementsByName('admin_id123')[0].value;
