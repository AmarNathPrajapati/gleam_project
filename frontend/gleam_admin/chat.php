...
?><?php 
    ...
    if (!isset($_SESSION["is_gleam_admin"])) {
        ...
        $stmt="SELECT countries.country_name ,applications_by_agents.* FROM applications_by_agents 
                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-8 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight mb-3">Application Activity</h1>
                            </div>
                            <!-- Actions -->
                        ...
                        <div class="card-header">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="view_box border-1 mb-3" >
                                   ...
                                   <!-- <div name="leftMessage" class="leftMessage" id="leftMessage">
                                        <p class="message">From Agent</p>
                                        <p class="time">Time</p>
                                   </div>
                                   <div name="rightMessage" class="rightMessage" id="rightMessage">
                                      <p class="message">From You</p>
                                      <p class="time">Time</p>
                                    </div> -->
                                </div>
                                <div class="send_box">
