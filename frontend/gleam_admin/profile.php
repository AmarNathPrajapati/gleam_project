                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow border-0 mb-7">
                        ...
                        <div class="container-fluid p-sm-5 my-5" style="font-size: 22px;">
                            <form action="../../backend/gleam_admin/update_details.php" method="post">
                                <div class="row mb-3">
                                <input type="text" id="gleam_admin_id" hidden readonly style="background-color: transparent; outline: none;" 
                                       name="gleam_admin_id" value="<?php echo $row["id"];?>" class="d-none">
