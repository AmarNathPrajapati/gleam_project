                    ...
                    <div class="card shadow border-0 mb-7">
                        <div class="card-header">
                            <div class="container-fluid p-sm-5 my-5" style="font-size: 22px;">
                                <form id="update_form" action="../../backend/admin/admin_application_update.php" onsubmit="return submitform()" method="post"
                                    ...
                                    <?php 
                                        ...
                                        if($data->num_rows==0){
                                            ...
                                            while($row=mysqli_fetch_array($data)){
                                                ?>
                                                <div name="<?php echo $row['from_user']==$_SESSION['admin_id']?'rightMessage':'leftMessage'?>" 
                                                    class="<?php echo $row['from_user']==$_SESSION['admin_id']?'rightMessage':'leftMessage'?>">
                                                    <h6  class="<?php echo $row['from_user']==$_SESSION['admin_id']?'textWhite':'textDark'?> sender_name"><?php  
                                                        if($row['from_user']!=$_SESSION['admin_id']){
                                                            echo "By ".$row['name'];
                                                        }
                                                        // else{
                                                        //     echo 'By You';
