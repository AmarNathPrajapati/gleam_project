                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight mb-4">Activity</h1>
                            </div>
                            <!-- Actions -->
                        ...
                        <div class="table-responsive" style="padding: 30px 18px;">
                            <table class="table table-hover table-nowrap" id="myTable" style="border: 0px solid black !important; padding: 30px 2px;">
                                <thead class="thead-light">
                                    <tr>
                                        <th style="font-size: 15px;">Sno</th>
                                        <th style="font-size: 15px;">Document Name</th>
                                        <th style="font-size: 15px;">Students Name</th>
                                        <th style="font-size: 15px;">Students Phone</th>
                                ...
                                <tbody >
                                    ...
                                    // echo $_GET['document_id12'];
                                        ...
                                        INNER JOIN `users` 
                                        ON users.id=activity.student_id 
                                        WHERE documents.id=(?)";
                                        ...
                                        mysqli_stmt_bind_param($sql,'i',$_GET['document_id12']);
