                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow border-0 mb-7 p-sm-5">
                        ...
                        <div class="form-box px-sm-5 mb-5">
                            <form class="px-sm-5" action="../../backend/admin/edit_post.php"
                            onsubmit="return showloader()" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="Post Title" required class="form-control" id="name" name="post_title" value="<?php echo $_GET["post_title"];?>">
                                </div>
                                <div class="mb-3">
                                    <label for="description" class="form-label">Post Description</label>
                                    <input type="text" placeholder="Post Description" required value="<?php echo $_GET["post_description"];?>" class="form-control" id="description" name="post_description">
                                </div>
                                <div class="mb-3">
                                ...
                                <select class="form-select mb-3" name="active">
                                    ...
                                    <option <?php echo $_GET["active"]==0?"selected":""?> value="0">Unactive</option>
