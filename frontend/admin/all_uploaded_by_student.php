                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">Student Applications</h1>
                            </div>
                            <!-- Actions -->
                        ...
                        <ul class="nav nav-tabs overflow-x border-0">
                         ...
                         <ul class="nav nav-tabs mt-4 overflow-x border-0">
                            <li class="nav-item ">
                                <a href="./dashboard.php" class="nav-link">Uploaded By You</a>
                            </li>
                            <li class="nav-item">
                                <a href="./all_uploaded_by_student.php" class="nav-link active font-regular">Student Applications</a>
                            </li> 
                            <!-- <li class="nav-item">
                                <a href="#" class="nav-link font-regular">File requests</a>
                            </li> -->
                            ...
                            <table class="table table-hover table-nowrap" id="myTable" style="border: 0px solid black !important; padding: 30px 2px;">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th style="font-size: 16px;">Activity Type</th>
                                    </tr>
                                </thead>
                                <tbody >
                                    <?php
                                    // echo $_GET['document_id12'];
                                        ...
                                        $stmt="SELECT documents.name AS d_name,users.name AS s_name, users.phone 
                                        AS s_phone,activity.activity_type,activity.created_at AS activity_time
                                         FROM `activity` 
                                        INNER JOIN `documents` 
                                        ON documents.id=activity.document_id
                                        INNER JOIN `users` 
                                        ON users.id=activity.student_id WHERE activity.activity_type=(?)
                                       ";
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 18px;">
                                        <?php echo $row["activity_type"]==2?"Document Upload":"Document Download";?>
                                        </td>
