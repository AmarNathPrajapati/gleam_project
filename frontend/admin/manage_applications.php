                ...
                <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            $stmt="SELECT count(id) FROM `applications_by_agents` 
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            $stmt="SELECT count(id) FROM `applications_by_agents` WHERE status=(?) AND deleted_at IS NULL";
                                            $sql=mysqli_prepare($conn, $stmt);

                                            // $is_admin=0;
                                            mysqli_stmt_bind_param($sql,'i',$stats);
                                            $status=0;
                    ...
                    <div class="card shadow border-0 mb-7">
                        <div class="card-header">
                            ...
                            <form action="./manage_applications.php" id="filter_form" method="get">
                                ...
                                <tbody>
                                    <?php
                                       ...
                                       if (isset($_GET['filter']) && $_GET['filter']==0) {
                                           ...
                                           WHERE applications_by_agents.status=(?) AND applications_by_agents.deleted_at IS NULL ORDER BY applications_by_agents.created_at";
                                           $sql=mysqli_prepare($conn, $stmt);
                                           mysqli_stmt_bind_param($sql,'i',$_GET['filter']);
                                           $status=0;
                                       ...
                                       elseif(isset($_GET['filter']) && $_GET['filter']==1){
                                            ...
                                            INNER JOIN countries ON countries.id=applications_by_agents.country_id
                                            INNER JOIN status_assumptions ON status_assumptions.status_number=applications_by_agents.status
                                            WHERE applications_by_agents.status=(?) AND applications_by_agents.deleted_at IS NULL 
                                            ORDER BY applications_by_agents.created_at";
                                            $sql=mysqli_prepare($conn, $stmt);
                                            mysqli_stmt_bind_param($sql,'i',$_GET['filter']);
                                            $status=1;
                                        }
                                        ...
                                        elseif(isset($_GET['filter']) && $_GET['filter']==3){
                                            ...
                                            INNER JOIN countries ON countries.id=applications_by_agents.country_id
                                            INNER JOIN status_assumptions ON status_assumptions.status_number=applications_by_agents.status
                                            WHERE applications_by_agents.deleted_at IS NULL ORDER BY applications_by_agents.created_at";
                                            $sql=mysqli_prepare($conn, $stmt);
                                            // mysqli_stmt_bind_param($sql,'');
                                       }
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <th>
                                                                                    <form action="../../backend/admin/remove_assigned_admin.php" method="post">
																						...
																						<input  type="text" hidden name="from_location" value="manage_applications.php">
